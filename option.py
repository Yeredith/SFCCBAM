...
parser.add_argument("--resume", default="", type=str, help="Path to checkpoint (default: none)  checkpoint/model_epoch_80.pth")
...
# Test image
parser.add_argument('--model_name', default='checkpoint/model_4_epoch_80.pth', type=str, help='super resolution model name ')
